...
public class AddressActivity extends AppCompatActivity implements  AddressAdapter.SelectedAddress{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String overAllAmount = getIntent().getExtras().getString("overAllAmount");

        System.out.println("----------------------------------------------------------------Address--------------------------------"+ overAllAmount);

        //get Data from detaisled activity
        ...
        paymentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(obj instanceof ShowAllModel){
                    ...
                    amount = Double.parseDouble(overAllAmount);
                    System.out.println("------------------------------------------------------------------------------------------"+amount);
                ...
                System.out.println("-------------------------------------------------FinalAmount-----------------------------------------"+amount);
